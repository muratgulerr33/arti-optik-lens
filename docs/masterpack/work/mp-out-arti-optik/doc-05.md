...
Bu doküman, ARTI OPTİK Next projesinin "native app hissi" veren UX kurallarını, dokunsal etkileşim standartlarını ve kullanıcı geri bildirimi pattern'lerini tanımlar. Amaç: AI asistanların (Cursor/ChatGPT) tutarlı, native-feel UX tasarımı yapmasını sağlamak ve UI/UX çizgisini korumak.
