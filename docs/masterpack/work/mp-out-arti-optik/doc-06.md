...
Bu doküman, ARTI OPTİK Next projesinin frontend kodlama standartlarını, best practice'lerini ve geliştirme kurallarını tanımlar. Amaç: AI asistanların (Cursor/ChatGPT) tutarlı, kaliteli ve bakımı kolay kod yazmasını sağlamak ve frontend geliştirme standartlarını merkezi bir yerde toplamak.
