...
Bu doküman, ARTI OPTİK Next projesindeki tüm component'lerin envanterini, kullanım yerlerini ve bağımlılıklarını tanımlar. Amaç: AI asistanların (Cursor/ChatGPT) gereksiz component yazmasını engellemek ve mevcut component'leri doğru şekilde kullanmasını sağlamak.
