...
Bu doküman, arti-optik-next projesi için frontend ve route handler güvenlik standartlarını ve dependency yönetim politikasını tanımlar. Aşağıdaki güvenlik alanlarını kapsar:
...
- `SMTP_FROM` - Gönderen email adresi (default: `"Destek <destek@artioptiklens.com.tr>"`)
- `ADMIN_NOTIFY_TO` - Admin bildirim email adresi (default: `"destek@artioptiklens.com.tr"`)
