...
export function AuthCard() {
  ...
  const callbackUrl =
    searchParams.get("callbackUrl") ?? searchParams.get("returnTo") ?? "/hesabim"
  ...
  return (
    <Card className="w-full max-w-md p-6">
      ...
      <div className="space-y-3">
        <Button
          type="button"
          className="w-full border border-border bg-white text-black hover:bg-gray-50 dark:bg-white dark:text-black dark:hover:bg-gray-100"
        ...
        <Button
          type="button"
          className="w-full bg-[#1877F2] text-white hover:bg-[#1864D9]"
          onClick={handleSocialClick}
        >
